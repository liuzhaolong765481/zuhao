        ...
        <div class="layui-row layui-col-space15 larryms-data-top">
            <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 layui-col-lg12">
                <script type="text/html" id="tools">
                    <button type="button" class="layui-btn" lay-event="add">添加文章</button>
                </script>
                <table lay-filter="article_table" class="layui-table" lay-data="{height:'full-155',cellMinWidth:95,url:'{{url('admin/application/article-list')}}', page:true, id:'article_table',toolbar:'#tools',defaultToolbar:[]}">
                    <thead>
                    <tr>
